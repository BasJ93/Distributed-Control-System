...
tie %Config, 'Config', {
    ...
    cc => 'arm-xilinx-linux-gnueabi-gcc  -march=armv7-a -mfloat-abi=softfp -mfpu=neon -mtune=cortex-a9 -Wl,--hash-style=gnu ',
    cccdlflags => '-fPIC',
    ...
    eunicefix => ':',
    exe_ext => '',
    full_ar => '/proj/xbuilds/2015.4_daily_latest/installs/lin64/SDK/2015.4/gnu/arm/lin//bin/arm-xilinx-linux-gnueabi-ar',
    inc_version_list => ' ',
    installman1dir => '',
    installman3dir => '',
    ...
    intsize => '4',
    ld => 'arm-xilinx-linux-gnueabi-gcc  -march=armv7-a -mfloat-abi=softfp -mfpu=neon -mtune=cortex-a9 -Wl,--hash-style=gnu ',
