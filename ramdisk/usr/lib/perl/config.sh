...
ccname="arm-xilinx-linux-gnueabi-gcc  -march=armv7-a -mfloat-abi=softfp -mfpu=neon -mtune=cortex-a9 -Wl,--hash-style=gnu "
ccsymbols=''
ccversion=''
cf_by='Open Embedded'
...
cpplast='-'
cppminus='-'
cpprun="arm-xilinx-linux-gnueabi-gcc  -march=armv7-a -mfloat-abi=softfp -mfpu=neon -mtune=cortex-a9 -Wl,--hash-style=gnu  -E"
cppstdin="arm-xilinx-linux-gnueabi-gcc  -march=armv7-a -mfloat-abi=softfp -mfpu=neon -mtune=cortex-a9 -Wl,--hash-style=gnu  -E"
