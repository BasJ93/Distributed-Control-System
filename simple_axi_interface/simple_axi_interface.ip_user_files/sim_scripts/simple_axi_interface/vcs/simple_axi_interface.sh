...
#
# Filename    : simple_axi_interface.sh
...
#
# Generated by Vivado on Thu Feb 18 11:20:51 CET 2016
# IP Build 1412160 on Tue Nov 17 13:47:24 MST 2015 
#
# usage: simple_axi_interface.sh [-help]
# usage: simple_axi_interface.sh [-lib_map_path]
# usage: simple_axi_interface.sh [-noclean_files]
# usage: simple_axi_interface.sh [-reset_run]
#
...
# executing this script. Please type 'simple_axi_interface.sh -help' for more information.
#
...
# Script info
echo -e "simple_axi_interface.sh - Script generated by export_simulation (Vivado v2015.4 (64-bit)-id)\n"

# Script usage
usage()
{
  msg="Usage: simple_axi_interface.sh [-help]\n\
Usage: simple_axi_interface.sh [-lib_map_path]\n\
Usage: simple_axi_interface.sh [-reset_run]\n\
Usage: simple_axi_interface.sh [-noclean_files]\n\n\
...
if [[ ($# == 1 ) && ($1 != "-lib_map_path" && $1 != "-noclean_files" && $1 != "-reset_run" && $1 != "-help" && $1 != "-h") ]]; then
  echo -e "ERROR: Unknown option specified '$1' (type \"./simple_axi_interface.sh -help\" for more information)\n"
  exit 1
fi
...
setup()
{
  case $1 in
    "-lib_map_path" )
      if [[ ($2 == "") ]]; then
        echo -e "ERROR: Simulation library directory path not specified (type \"./simple_axi_interface.sh -help\" for more information)\n"
        exit 1
      fi
...
reset_run()
{
  files_to_remove=(ucli.key simple_axi_interface_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log 64 AN.DB csrc simple_axi_interface_simv.daidir)
...
compile()
{
  ...
  vlogan -work xil_defaultlib $opts_ver +v2k +incdir+"$ref_dir/../../../ipstatic/axi_infrastructure_v1_1/hdl/verilog" +incdir+"$ref_dir/../../../ipstatic/processing_system7_bfm_v2_0/hdl" \
    ...
    "$ref_dir/../../../../simple_axi_interface.srcs/sources_1/bd/simple_axi_interface/ip/simple_axi_interface_processing_system7_0_0/sim/simple_axi_interface_processing_system7_0_0.v" \
  2>&1 | tee -a vlogan.log

  vhdlan -work xil_defaultlib $opts_vhd \
    "$ref_dir/../../../../simple_axi_interface.srcs/sources_1/bd/simple_axi_interface/ipshared/user.org/simple_axi_interface_v1_01/hdl/simple_axi_interface_v1_0_S00_AXI.vhd" \
    "$ref_dir/../../../../simple_axi_interface.srcs/sources_1/bd/simple_axi_interface/ipshared/user.org/simple_axi_interface_v1_01/hdl/simple_axi_interface_v1_0.vhd" \
    "$ref_dir/../../../../simple_axi_interface.srcs/sources_1/bd/simple_axi_interface/ip/simple_axi_interface_simple_axi_interface_0_0/sim/simple_axi_interface_simple_axi_interface_0_0.vhd" \
  ...
  vhdlan -work xil_defaultlib $opts_vhd \
    "$ref_dir/../../../../simple_axi_interface.srcs/sources_1/bd/simple_axi_interface/ip/simple_axi_interface_rst_processing_system7_0_50M_0/sim/simple_axi_interface_rst_processing_system7_0_50M_0.vhd" \
  2>&1 | tee -a vhdlan.log
  ...
  vlogan -work xil_defaultlib $opts_ver +v2k +incdir+"$ref_dir/../../../ipstatic/axi_infrastructure_v1_1/hdl/verilog" +incdir+"$ref_dir/../../../ipstatic/processing_system7_bfm_v2_0/hdl" \
    "$ref_dir/../../../../simple_axi_interface.srcs/sources_1/bd/simple_axi_interface/ip/simple_axi_interface_auto_pc_0/sim/simple_axi_interface_auto_pc_0.v" \
  2>&1 | tee -a vlogan.log

  vhdlan -work xil_defaultlib $opts_vhd \
    "$ref_dir/../../../../simple_axi_interface.srcs/sources_1/bd/simple_axi_interface/hdl/simple_axi_interface.vhd" \
  2>&1 | tee -a vhdlan.log
...
elaborate()
{
  ...
  vcs $opts xil_defaultlib.simple_axi_interface xil_defaultlib.glbl -o simple_axi_interface_simv
}
...
simulate()
{
  ...
  ./simple_axi_interface_simv $opts -do simulate.do
}
# Script usage
usage()
{
