...
#
# Generated by export_simulation on Thu Feb 18 11:20:51 CET 2016
#
################################################################################
...
switch to the './simple_axi_interface.sh' script.

./simple_axi_interface.sh -reset_run
...
./simple_axi_interface.sh -noclean_files

For more information on the script, please type './simple_axi_interface.sh -help'.
