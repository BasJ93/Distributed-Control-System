...
*.[0-9]*)
	...
	if test ! -f /home/bas/workspace/ncurses/build/man_alias.sed ; then
cat >>/home/bas/workspace/ncurses/build/man_alias.sed <<-CF_EOF2
		s,@DATADIR@,$datadir,g
...
s,@TSET@,tset,g
CF_EOF2
		echo "...made /home/bas/workspace/ncurses/build/man_alias.sed"
	fi
	...
	aliases=`sed -f $top_srcdir/man/manlinks.sed $inalias |sed -f /home/bas/workspace/ncurses/build/man_alias.sed | sort -u`
	cf_target=`grep "^$cf_source" /home/bas/workspace/ncurses/src/ncurses-5.9/man/man_db.renames | mawk '{print $2}'`
	...
	sed	-f /home/bas/workspace/ncurses/build/man_alias.sed \
		< $i | sed -f /home/bas/workspace/ncurses/build/edit_man.sed >$TMP
