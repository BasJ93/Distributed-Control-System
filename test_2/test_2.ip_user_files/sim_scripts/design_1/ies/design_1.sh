...
compile()
{
  ...
  ncvhdl -work xil_defaultlib $opts_vhd \
    "$ref_dir/../../../bd/design_1/ipshared/user.org/simple_axi_interface_v1_01/hdl/simple_axi_interface_v1_0_S00_AXI.vhd" \
    "$ref_dir/../../../bd/design_1/ipshared/user.org/simple_axi_interface_v1_01/hdl/simple_axi_interface_v1_0.vhd" \
    "$ref_dir/../../../bd/design_1/ip/design_1_simple_axi_interface_0_0/sim/design_1_simple_axi_interface_0_0.vhd" \
